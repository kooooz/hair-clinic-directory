...
export const metadata: Metadata = {
  ...
  description: "Entdecke empfohlene Vitamine, Shampoos und Pflegeprodukte für eine optimale Heilung und gesundes Haarwachstum nach deiner Haartransplantation.",
}
