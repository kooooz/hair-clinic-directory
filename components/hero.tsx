export function Hero() {
  return (
    <section className="relative w-full min-h-[140vh] pt-28 md:pt-48">
      <div className="absolute inset-0 z-0 mt-16 md:mt-32">
        <img
      ...
      <div className="relative z-20 container mx-auto px-4 flex flex-col items-center justify-center h-full text-center mb-24 md:mb-64 py-16 md:py-0">
